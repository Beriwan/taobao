...
DOWNLOADER_MIDDLEWARES = {
    ...
    #'taobao.middlewares.MyproxisSpiderMidleware': 125,
    #'taobao.middlewares.RandomUserAgent': 100
}
...
USER_AGENTS = [
    ...
    'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/534.57.2 (KHTML, like Gecko) Version/5.1.7 Safari/534.5',
